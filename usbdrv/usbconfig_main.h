 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdb, 0x27 /* USB HID keyboard */
 ...
 */
#define USB_CFG_VENDOR_NAME     'a','n','c','i','l','l','a','.','c','a'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D','i','g','i','S','p','a','r','k'
 ...
 */
  // Configuration for DigiSpark, using PCINT0
